...
const ShortAnswerCard = ({ index = 2 }) => {
  return (
    <div className="rounded-2xl border border-primary bg-white p-6 shadow-sm transition-all hover:shadow-md">
      ...
      {/* Short Answer Input Placeholder (Read-only visual) */}
      <div className="mt-6 ml-10">
        <div className="h-11 w-3/4 max-w-3xl rounded-xl border border-dashed border-border bg-[#F8FAFD]" />
      </div>
